  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="flex flex-col items-center gap-4 animate-fade-in">
        <img src="/logo.png" alt="Pyronex Logo" className="w-12 h-12 rounded-2xl object-contain shadow-lg" />
        <div className="w-8 h-8 rounded-full border-2 border-neon-indigo border-t-transparent animate-spin" />
        <p className="text-muted-foreground text-sm">Routing through Pyronex...</p>
      </div>
    </div>
  );
}
